...
function ExpandingLogo() {
  return (
    <img
      src={ExpandLogo}
      alt="expand"
      className="talent-operations-expanding-logo"
    ></img>
  );
}
...
function CollapsingLogo() {
  return (
    <img
      src={CollapseLogo}
      alt="collapse"
      className="talent-operations-collapsing-logo"
    ></img>
  );
}
...
function FAQ() {
  return (
    <div className="talent-operations-faq-wrapper">
      <div className="talent-operations-faq-container">
        <div className="talent-operations-faq-left-section">
          <img
            src={FaqImage}
            alt="faq"
            className="talent-operations-faq-image"
          />
          <h1 className="talent-operations-faq-title">
            Frequently Asked Questions
          </h1>
        </div>
        <div className="talent-operations-faq-section-container">
          <Faq
            data={data}
            config={{
              animate: true,
