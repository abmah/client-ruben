...
const data = {
  rows: [
    ...
    },
    {
      ...
      content:
        "Talent augmentation can cover a wide range of skills, including but not limited to software development, project management, digital marketing, data analysis, strategy, cybersecurity, and design, depending on the specific needs of the organization.",
    },
    {
